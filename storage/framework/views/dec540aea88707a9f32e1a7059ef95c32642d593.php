...
<div class="container montse">
    <div class="row">
        ...
        <br><br>
            <h2 class="text-center montseh2">CATÁLOGO TIPO DE TRANSMISIÓN</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <a class="btn btn-primary" href="/cat_tipotransmision/create"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Agregar Tipo de Transmisión</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $tt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($x->id); ?></td>
                    <td class="text-center"><?php echo e($x->descripcion); ?></td>
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_tipotransmision/<?php echo e($x->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_tipotransmision/<?php echo e($x->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/vehiculos/tipotransmision/index.blade.php ENDPATH**/ ?>