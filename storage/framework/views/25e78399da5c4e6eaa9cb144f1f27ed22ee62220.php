            ...
            <form action="/cat_tipoempleados/<?php echo e($te->id); ?>" method="POST">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="cliente_id" id="cliente_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($cliente->id == $te->cliente_id): ?>
                                selected
                                <?php endif; ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="<?php echo e($te->descripcion); ?>">
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/tipoempleados/edit.blade.php ENDPATH**/ ?>