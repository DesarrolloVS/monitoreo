...
<div class="container">
    ...
    <div class="row">
        <div class="col">
        <br><br>
            <a class="btn btn-success" href="/cat_marca"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Marcas</a>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sismon\resources\views/catalogos/marca/confirmDelete.blade.php ENDPATH**/ ?>