...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Eliminar Registro: <small><?php echo e($ts->descripcion); ?></small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
        <br><br>
            <a class="btn btn-success" href="/cat_tiposervicios"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Tipo de Servicios</a>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/tiposervicios/confirmDelete.blade.php ENDPATH**/ ?>