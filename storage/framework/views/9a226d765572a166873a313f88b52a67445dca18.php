...
<div class="container montse">
    <div class="row">
        ...
        <br><br>
            <h2 class="text-center montseh2">CATÁLOGO ESTADOS USUARIO</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 col-offset-1">
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $eus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="text-center"><?php echo e($eu->id); ?></td>
                    <td class="text-center"><?php echo e($eu->descripcion); ?></td>
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_estadosusuario/<?php echo e($eu->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_estadosusuario/<?php echo e($eu->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/estadosusuario/index.blade.php ENDPATH**/ ?>