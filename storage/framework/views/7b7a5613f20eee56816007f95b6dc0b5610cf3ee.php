...
<div class="container montse">
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <a class="btn btn-success" href="/cat_tipouso"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Tipo de Uso</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_tipouso/<?php echo e($tu->id); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="<?php echo e($tu->descripcion); ?>">
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/vehiculos/tipouso/edit.blade.php ENDPATH**/ ?>