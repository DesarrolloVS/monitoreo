...
<div class="container montse">
    <div class="row">
        ...
        <br><br>
            <h2 class="text-center montseh2">DOMICILIOS - <?php echo e($cliente->nombre); ?></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br>
            <a class="btn btn-primary" href="/cat_domicilios/<?php echo e($cliente->id); ?>/create"><i class="fas fa-plus"></i>&nbsp;&nbsp;&nbsp;Agregar Domicilio</a>
        </div>
    </div>

    <?php if($domicilios->first()): ?>
    <div class="row">
        <br>
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($d->calle); ?>, <?php echo e($d->exterior); ?><?php if($d->interior): ?>, <?php echo e($d->interior); ?><?php endif; ?>, <?php echo e($d->colonia); ?>, <?php echo e($d->cp); ?></td>
                    <td class="text-center"><?php echo e($d->ciudad); ?></td>
                    <td class="text-center"><?php echo e($d->estado); ?></td>
                    <td class="text-center"><?php echo e($d->tipodomicilio_id); ?></td>
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_domicilios/<?php echo e($d->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_tiposervicios/<?php echo e($d->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/domicilios/index.blade.php ENDPATH**/ ?>