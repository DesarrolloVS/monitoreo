...
<div class="container montse">
    <div class="row">
        <br><br>
        <div class="">
            <h2>Responsables Actuales: <small>Placa: <?php echo e($v->placa); ?> </small></h2>
        </div>
    </div>
        ...
        <div class="">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_vehiculos/<?php echo e($h->id); ?>/deleteResponsable"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/vehiculos/vehiculos/responsablesactuales.blade.php ENDPATH**/ ?>