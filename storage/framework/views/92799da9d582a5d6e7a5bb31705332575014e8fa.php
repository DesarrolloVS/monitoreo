        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e(str_limit($r->usuario->nombre." ".$r->usuario->paterno." ".$r->usuario->materno,30)); ?></td>
                    <td class="text-center"><?php echo e(str_limit($r->cliente->nombre,30)); ?></td>
                    <td class="text-center"><?php echo e($r->turno->descripcion); ?></td>
                    <td class="text-center"><a class="btn btn-info btn-xs" href="/cat_respveh/<?php echo e($r->id); ?>/estatus"><?php echo e(($r->estadoresponsablevehiculo_id == "" ) ? estatus_responsable($r->estadoresponsablevehiculo_id) : $r->estadoresponsablevehiculo->descripcion); ?>&emsp;<i class="fas fa-exchange-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_respveh/<?php echo e($r->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_respveh/<?php echo e($r->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/respveh/index.blade.php ENDPATH**/ ?>