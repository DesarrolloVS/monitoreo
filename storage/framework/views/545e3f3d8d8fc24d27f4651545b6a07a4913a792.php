...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-offset-1"><br><br><br>
            <h2 class="text-center montseh2">Responsables de Vehículos</h1><br><br><br>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/respveh/main.blade.php ENDPATH**/ ?>