...
<div class="container">
    ...
    <div class="row">
        <div class="col"><br>
            ...
            <p class="">Cliente: <?php echo e($x->cliente->nombre); ?></p>
            <p class="">Parametro: <?php echo e($x->parametro); ?></p>
            <p class="">Descripción: <?php echo e($x->descripcion); ?></p>
            <p class="">Valor: <?php echo e($x->valor); ?></p>
        </div>
    </div>

    <div class="row">
        <div class="col">
            <form action="/cat_parametroscliente/<?php echo e($x->id); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/parametroscliente/confirmDelete.blade.php ENDPATH**/ ?>