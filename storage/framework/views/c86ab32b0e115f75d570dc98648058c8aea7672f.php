...
<div class="container montse">
    <div class="row">
        ...
        <div class="text-center">
            <h2>Modificar Estatus Vehiculo: <small>Placa: <?php echo e($v->placa); ?> </small></h2>
        </div>
    </div>
    ...
    <div class="row"><br><br>
        <div class="col-md-4 col-md-offset-4">
            <h3>Estatus Actual: <?php echo e(($v->estadovehiculo_id == "" ) ? estatus_vehiculos($v->estadovehiculo_id) : $v->estadovehiculo->descripcion); ?></h3>
    </div>
    </div>
    ...
    <div class="row">
        <div class="">
            <br><br>
            <form action="/cat_vehiculos/<?php echo e($v->id); ?>/estatus" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-md-offset-4">
                        ...
                        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($estado->id != $v->estadovehiculo_id): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/vehiculos/vehiculos/estatus.blade.php ENDPATH**/ ?>