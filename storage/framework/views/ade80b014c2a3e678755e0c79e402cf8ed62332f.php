...
<div class="container montse">
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <h2>Modificar Responsable: <small>( <?php echo e($r->usuario->nombre." ".$r->usuario->paterno." ".$r->usuario->materno); ?> )</small></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_respveh/<?php echo e($r->id); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <select name="cliente_id" id="cliente_id" class="form-control">
                            ...
                            <?php if($cliente->id == $r->cliente_id): ?>
                            selected
                            <?php endif; ?>
                    ...
                    <div class="form-group col-md-4" id="usuarios">
                        ...
                        <select name="usuario_id" id="usuario_id" class="form-control">
                            ...
                            <?php if($u->id == $r->usuario_id): ?>
                            selected
                            <?php endif; ?>
                            ><?php echo e($u->nombre." ".$u->paterno." ".$u->materno); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-group col-md-4" id="turnos">
                        ...
                        <select name="turno_id" id="turno_id" class="form-control">
                            ...
                            <?php if($t->id == $r->turno_id): ?>
                            selected
                            <?php endif; ?>
                            ><?php echo e($t->descripcion); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<?php echo $__env->make('template.menu_catalogos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/respveh/edit.blade.php ENDPATH**/ ?>