...
<div class="container montse">
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <h2>Modificar Estatus Cliente: <small><?php echo e($cliente->nombre); ?></small></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_clientes/<?php echo e($cliente->id); ?>/estatus" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.menu_catalogos', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/cliente/estatus.blade.php ENDPATH**/ ?>