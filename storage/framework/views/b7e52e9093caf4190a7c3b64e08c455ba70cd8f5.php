                ...
                <div class="col">
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-success btn-sm" href="/cat_estadotrazas/<?php echo e($e->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                            <td class="text-center"><a class="btn btn-danger btn-sm" href="/cat_estadotrazas/<?php echo e($e->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/estadotrazas/index.blade.php ENDPATH**/ ?>