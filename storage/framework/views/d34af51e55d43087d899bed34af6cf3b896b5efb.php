...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Desvincular Responsable vehículo <small>Placa: <?php echo e($v->placa); ?></small></h1>
            <h1>Responsable <small> <?php echo e($r->usuario->nombre); ?> <?php echo e($r->usuario->paterno); ?> <?php echo e($r->usuario->materno); ?></small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form action="/cat_vehiculos/deleteResponsable/<?php echo e($r->id); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/vehiculos/vehiculos/deleteResponsable.blade.php ENDPATH**/ ?>