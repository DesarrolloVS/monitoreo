...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Eliminar Registro: <small><?php echo e($us->nombre); ?> <?php echo e($us->paterno); ?> <?php echo e($us->materno); ?></small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form action="/cat_usuarios/<?php echo e($us->id); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/usuario/confirmDelete.blade.php ENDPATH**/ ?>