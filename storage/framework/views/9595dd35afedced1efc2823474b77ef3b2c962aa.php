...
<div class="container montse">
    <div class="row">
        <div class="text-center">
            <br>
            <h2 montseh2>Agregar Tipo de Turno</h2>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <form action="/cat_tipoturnos" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/tipoturnos/create.blade.php ENDPATH**/ ?>