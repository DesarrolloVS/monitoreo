...
<div class="container montse">
    <div class="row">
        ...
        <br><br>
            <h2 class="text-center montseh2">CATÁLOGO TURNOS</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 col-offset-1">
    ...
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <tr>
                    <td class="text-center"><?php echo e($t->id); ?></td>
                    <td class="text-center"><?php echo e(str_limit($t->descripcion,30)); ?> </td>
                    <td class="text-center"><?php echo e($t->horainicio); ?></td>
                    <td class="text-center"><?php echo e($t->horafin); ?></td>
                    <td class="text-center"><?php echo e($t->tipoturno->descripcion); ?></td>
                    <td class="text-center"><a class="btn btn-info btn-xs" href="/cat_turnos/<?php echo e($t->id); ?>/estatus"><?php echo e(($t->estadoturno_id == "" ) ? estatus_turno($t->estadoturno_id) : $t->estadoturno->descripcion); ?>&emsp;<i class="fas fa-exchange-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_turnos/<?php echo e($t->id); ?>/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_turnos/<?php echo e($t->id); ?>/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/turnos/index.blade.php ENDPATH**/ ?>