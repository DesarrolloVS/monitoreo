...
<div class="container montse">
    ...
    <div class="row">   
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <form class="bg-white shadow rounded py-3 px-4" action="/cat_tipoempresas" method="POST">
                        <h3 class="text-center">Agregar Tipo de Empresa</h3>
                        <hr>
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/tipoempresas/create.blade.php ENDPATH**/ ?>