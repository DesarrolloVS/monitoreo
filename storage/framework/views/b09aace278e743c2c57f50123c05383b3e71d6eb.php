...
<div class="container montse">
    <div class="row">
        <div class="text-center">
            <br>
            <h2 montseh2>Agregar Tipo de Empresa</h2>
        </div>
    </div>
    ...
    <div class="row">
        <br><br>
        <div class="">
            <a class="btn btn-success" href="/cat_tipoempresas"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Tipo Empresas</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <form action="/cat_tipoempresas" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/monitoreo/resources/views/catalogos/tipoempresas/create.blade.php ENDPATH**/ ?>