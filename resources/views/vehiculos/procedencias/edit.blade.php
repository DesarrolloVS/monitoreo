...
<div class="container montse">
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <a class="btn btn-success" href="/cat_procedencia"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Procedencias</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_procedencia/{{ $procedencia->id }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $procedencia->descripcion }}">
                    </div>
                </div>
