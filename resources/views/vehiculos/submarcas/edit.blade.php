...
<div class="container montse">
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_submarca/{{ $submarca->id }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="row" id="sub"><br><br>
                    <div class="form-group col-md-6">
                        <label for="descripcion">Descripción: </label>
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $submarca->descripcion }}">
                    </div>
                </div>
