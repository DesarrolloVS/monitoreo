...
<div class="container montse">
    <div class="row">
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <form class="bg-white rounded shadow py-3 px-4" action="/cat_submarca/{{ $submarca->id }}" method="POST">
                        ...
                        <div class="row" id="sub">
                            <div class="form-group col">
                                ...
                                <input class="form-control bg-light shadow-sm border-0" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $submarca->descripcion }}">
                            </div>
                        </div>
