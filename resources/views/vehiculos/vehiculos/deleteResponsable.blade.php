...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Desvincular Responsable vehículo <small>Placa: {{ $v->placa }}</small></h1>
            <h1>Responsable <small> {{ $r->usuario->nombre }} {{ $r->usuario->paterno }} {{ $r->usuario->materno }}</small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form action="/cat_vehiculos/deleteResponsable/{{ $r->id }}" method="POST">
                {{ csrf_field() }}
                @method('delete')
                <br><br><br>
