...
<div class="container montse">
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_tipovehiculos/{{ $tv->id }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $tv->descripcion }}">
                    </div>
                </div>
