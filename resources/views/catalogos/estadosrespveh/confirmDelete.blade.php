...
<div class="container">
    ...
    <div class="row">
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <form class="bg-white shadow py-3 px-4" action="/cat_estadosrespveh/{{ $estado->id }}" method="POST">
                        ...
                        <a class="class btn btn-block btn-outline-dark" href="/cat_estadosrespveh"><i class="far fa-window-close"></i>&ensp;Cancelar</a>
                    </form>
                </div>
            </div>
</div>
