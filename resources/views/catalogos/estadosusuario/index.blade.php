            ...
            <div class="row">
                <div class="col">
                    <ol class="breadcrumb bg-transparent d-flex justify-content-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="">Catálogo Estados Usuarios</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col">
                    <table class="table table-bordered table-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-danger btn-sm" href="/cat_estadosusuario/{{ $eu->id }}/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                        @endforeach
                    </table>
                </div>
