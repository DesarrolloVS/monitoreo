...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Eliminar Registro: <small>{{ $eu->descripcion }}</small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
        <br><br>
            <a class="btn btn-success" href="/cat_estadosusuario"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Estados Usuario</a>
        </div>
    </div>

    <div class="row">
        <div class="col">
            <form action="/cat_estadosusuario/{{ $eu->id }}" method="POST">
                {{ csrf_field() }}
                @method('delete')
                <br><br><br>
