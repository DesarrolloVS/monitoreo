...
<div class="container montse">
    ...
    <div class="row" class="col-md-10 col-offset-1">
        <div>
            <br><br>
            <form action="/cat_parametroscliente/{{ $pc->id }}" method="POST">
                @csrf
                @method('put')
                <div class="row">
                ...
                <div class="row"><br><br>
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="text" id="parametro" name="parametro" placeholder="Parametro" value="{{ $pc->parametro }}">
                        {!! $errors->first('parametro', '<small style="color:red">:message</small>') !!}
                    </div>

                    <div class="form-group col-md-4">
                        <label for="descripcion">Descripcion: </label>
                        <input class="form-control" type="text" id="descripcion" name="descripcion" placeholder="Descripcion" value="{{ $pc->descripcion }}">
                        {!! $errors->first('descripcion', '<small style="color:red">:message</small>') !!}
                    </div>

                    <div class="form-group col-md-4">
                        <label for="valor">Valor: </label>
                        <input class="form-control" type="text" id="valor" name="valor" placeholder="Valor" value="{{ $pc->valor }}">
