...
<div class="container montse">
    <div class="row">
        <div class="text-center">
            <br>
            <h2 montseh2>Agregar Estado Traza</h2>
        </div>
    </div>
    ...
    <div class="row">
        <br><br>
        <div class="">
            <a class="btn btn-success" href="/cat_estadotrazas"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Estados Trazas</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <form action="/cat_estadotrazas" method="POST">
            @csrf
            <div class="row">
