      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Modificar Estado</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <section class="content">
            <div class="card card-solid">
                <div class="card-body">
                    <form class="bg-white shadow py-3 px-4" action="/cat_usuarioscte/{{ $usuario->id }}/estatus/{{ $cliente->id }}/cliente" method="POST">
