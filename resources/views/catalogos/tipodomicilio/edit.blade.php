  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="card card-solid">
            <div class="card-body">
                <form class="bg-white shadow rounded py-3 px-4" action="/cat_tipodomicilios/{{ $td->id }}" method="POST">
                    <hr>
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input class="form-control shadow-sm border-0 bg-light" type="text" id="descripcion" name="descripcion" placeholder="Descripción" value="{{ $td->descripcion }}">
