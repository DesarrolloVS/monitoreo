        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_tipodomicilios/{{ $td->id }}/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_tipodomicilios/{{ $td->id }}/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                @endforeach
            </table>
        </div>
