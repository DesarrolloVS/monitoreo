...
<div class="container">
    ...
    <div class="row">
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <form class="bg-white shadow py-3 px-4" action="/cat_tipopersonas/{{ $tp->id }}" method="POST">
                        <h3>Eliminar Registro: <small> {{ $tp->descripcion }}  </small></h3>
                        <hr>
                        {{ csrf_field() }}
                        @method('delete')
                        <br>
                        <button class="btn btn-danger btn-block" type="submit"><i class="fas fa-trash-alt"></i>&ensp;Eliminar</button>
                        <a class="class btn btn-block btn-outline-dark" href="/cat_tipopersonas"><i class="far fa-window-close"></i>&ensp;Cancelar</a>
                    </form>
                </div>
            </div>
</div>
