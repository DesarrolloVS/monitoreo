...
<div class="container">
    <div class="row">
        <div class="col"><br><br><br>
            <h1>Eliminar Registro: <small> {{ $te->descripcion }}  </small></h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
        <br><br>
            <a class="btn btn-success" href="/cat_tipoempresas"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Tipo de Empresas</a>
        </div>
    </div>

    <div class="row">
        <div class="col">
            <form action="/cat_tipoempresas/{{ $te->id }}" method="POST">
                {{ csrf_field() }}
                @method('delete')
                <br><br><br>
