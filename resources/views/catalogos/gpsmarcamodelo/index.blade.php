                ...
                <div class="col">
                    <table class="table table-bordered table-hover table-sm">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-success btn-sm" href="/cat_gpsmarcamodelo/{{ $g->id }}/edit"><i class="fas fa-pencil-alt"></i></a></td>
                            <td class="text-center"><a class="btn btn-danger btn-sm" href="/cat_gpsmarcamodelo/{{ $g->id }}/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                        </tr>
                        @endforeach
                    </table>
                </div>
