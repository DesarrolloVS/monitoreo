...
<div class="container montse">
    <div class="row">
        ...
        <br><br>
            <h2 class="text-center montseh2">CATÁLOGO GPS MARCA MODELO</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10 col-offset-1">
        ...
        <div class="col-md-10 col-offset-1">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><a class="btn btn-success btn-xs" href="/cat_gpsmarcamodelo/{{ $g->id }}/edit"><i class="fas fa-pencil-alt"></i></a></td>
                    <td class="text-center"><a class="btn btn-danger btn-xs" href="/cat_gpsmarcamodelo/{{ $g->id }}/confirmDelete"><i class="fas fa-trash-alt"></i></a></td>
                </tr>
                @endforeach
            </table>
        </div>
