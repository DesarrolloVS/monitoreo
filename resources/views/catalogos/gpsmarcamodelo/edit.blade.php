...
<div class="container montse">
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_gpsmarcamodelo/{{ $gps->id }}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="text" id="marca" name="marca" placeholder="Marca" value="{{ $gps->marca }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="modelo">Modelo: </label>
                    <input class="form-control" type="text" id="modelo" name="modelo" placeholder="Modelo" value="{{ $gps->modelo }}">
                </div>
            </div>
