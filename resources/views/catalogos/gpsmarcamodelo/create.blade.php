...
<div class="container montse">
    <div class="row">
        <div class="text-center">
            <br>
            <h2 montseh2>Agregar Gps Marca Modelo</h2>
        </div>
    </div>
    ...
    <div class="row">
        <br><br>
        <div class="">
            <a class="btn btn-success" href="/cat_gpsmarcamodelo"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Gps Marca Modelo</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <form action="/cat_gpsmarcamodelo" method="POST">
            @csrf
            <div class="row">
                <div class="form-group col-md-6">
                    <label for="marca">Marca: </label>
                    <input class="form-control" type="text" id="marca" name="marca" placeholder="Marca" value="">
                </div>
                <div class="form-group col-md-6">
                    <label for="modelo">Modelo: </label>
                    <input class="form-control" type="text" id="modelo" name="modelo" placeholder="Modelo" value="">
                </div>
            </div>
