...
<div class="container montse">
    <div class="row">
        <div class="text-center">
            <br>
            <h2 montseh2>Agregar Estado - Gps Cliente</h2>
        </div>
    </div>
    ...
    <div class="row">
        <br><br>
        <div class="">
            <a class="btn btn-success" href="/cat_estadogpscliente"><i class="fas fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Catálogo Estados - Gps Cliente</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <form action="/cat_estadogpscliente" method="POST">
            @csrf
            <div class="row">
