...
<div class="container">
    ...
    <div class="row">
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 mx-auto">
            ...
            <div class="row">
                <div class="col">
                    <form class="bg-white shadow py-3 px-4" action="/cat_gpscliente/{{ $gps->id }}" method="POST">                    
                        <h3 class="text-center">Eliminar Registro <small> Serie: {{ $gps->serie }}, Imei: {{ $gps->imei }} </small></h3>
                        <hr>
                        {{ csrf_field() }}
                        @method('delete')
                        <br>
