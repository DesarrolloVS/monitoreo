...
<div class="container montse">
    <div class="row">
        ...
        <div class="col-md-10 col-offset-1">
            <h2>Modificar Estatus GPS Cliente: <small>Serie: {{ $gps->serie }}, Imei: {{ $gps->imei }} </small></h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-10 col-offset-1">
            <br><br>
            <form action="/cat_gpscliente/{{ $gps->id }}/estatus" method="POST">
                @csrf
                @method('put')
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select name="estadogpscliente_id" id="estadogpscliente_id" class="form-control">
